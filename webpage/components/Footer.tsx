...
export function Footer() {
  return (
    <footer id="contact" className="border-t border-line bg-bg-elevated/60">
      <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8">
        ...
        <a
          ...
          className="mt-6 inline-block text-lg text-accent underline decoration-accent-soft underline-offset-4 hover:decoration-accent"
        >
          {profile.email}
        </a>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-line pt-6 text-xs text-fg-muted sm:flex-row sm:items-center sm:justify-between">
          <p>
            © {new Date().getFullYear()} {profile.name} · Built with care between time zones.
          </p>
          <LocalTime />
        </div>
      </div>
